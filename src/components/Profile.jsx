    ...
    <section className="pt-10 pb-24 bg-white px-4 relative overflow-hidden">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col justify-center items-center gap-16">
          ...
          <div 
            ref={refGroom}
            className={`flex flex-col items-center transition-all duration-1000 delay-200 ease-out transform ${
              isGroomVisible ? 'opacity-100 translate-x-0 scale-100' : 'opacity-0 -translate-x-20 scale-95'
            }`}
          >
          ...
          <div 
            ref={refAmp}
            className={`flex items-center justify-center my-2 transition-all duration-700 ease-out transform ${
              isAmpVisible ? 'opacity-100 scale-100 rotate-0' : 'opacity-0 scale-50 rotate-12'
            }`}
          >
          ...
          <div 
            ref={refBride}
            className={`flex flex-col items-center transition-all duration-1000 delay-200 ease-out transform ${
              isBrideVisible ? 'opacity-100 translate-x-0 scale-100' : 'opacity-0 translate-x-20 scale-95'
            }`}
          >
            <div className="relative mb-8 group cursor-pointer">
              <div className="absolute inset-0 border-2 border-primary -rotate-6 rounded-t-full rounded-b-full transition-all duration-500 group-hover:-rotate-12 group-hover:scale-105"></div>
