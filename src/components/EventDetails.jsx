    ...
    <section className="py-24 bg-white px-4 relative">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-script text-primary mb-4">Event Details</h2>
        ...
        >
          {/* Akad */}
          <div className="bg-secondary/20 p-8 rounded-2xl text-center border border-primary/20 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
